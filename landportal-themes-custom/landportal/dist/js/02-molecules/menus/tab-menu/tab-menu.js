...
/******/ 	return __webpack_require__(__webpack_require__.s = "./components/02-molecules/menus/tab-menu/tab-menu.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./components/02-molecules/menus/tab-menu/tab-menu.js":
/*!************************************************************!*\
  !*** ./components/02-molecules/menus/tab-menu/tab-menu.js ***!
  \************************************************************/
/*! no exports provided */
...
Drupal.behaviors.tabMenu={attach:function attach(a){var b=a.getElementById("toggle-expand"),c=a.getElementById("tab-nav");if(c){var d=c.getElementsByClassName("expand-sub");b.addEventListener("click",function(a){b.classList.toggle("toggle-expand--open"),c.classList.toggle("tab-nav--open"),a.preventDefault()}),Array.from(d).forEach(function(a){a.addEventListener("click",function(a){var b=a.currentTarget,c=b.nextElementSibling;b.classList.toggle("expand-sub--open"),c.classList.toggle("tab-menu--sub-open")})})}}};
