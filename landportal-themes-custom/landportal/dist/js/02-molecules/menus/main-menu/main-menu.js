...
Drupal.behaviors.mainMenu={attach:function attach(a){var b=a.getElementById("toggle-expand"),c=a.getElementById("main-nav"),d=a.getElementById("block-languageswitcher"),f=a.getElementById("block-useraccountmenu").querySelector(".inline-menu--account");if(c){var g=c.getElementsByClassName("expand-sub");b.addEventListener("click",function(a){c.classList.toggle("main-nav--open"),d.classList.toggle("main-nav--open"),f.classList.toggle("main-nav--open"),a.preventDefault()}),Array.from(g).forEach(function(a){a.addEventListener("click",function(a){var b=a.currentTarget,c=b.nextElementSibling;b.classList.toggle("expand-sub--open"),c.classList.toggle("main-menu--sub-open")})})}d.addEventListener("click",function(a){var b=a.currentTarget,c=b.querySelector(".links");c.classList.toggle("language-switcher--open")})}};
