...
class BusinessRulesListener implements EventSubscriberInterface {
   ...
   *
   * @param Symfony\Component\HttpKernel\Event\RequestEvent|Symfony\Component\HttpKernel\Event\TerminateEvent $event
   *   The event object.
   * @param string $event_name
   *   The event name.
   */
  public function registerDynamicEvents($event, $event_name) {
