...
/**
 * Provides a plugin for the 'schema_creativework_aggregate_rating' meta tag.
 *
 ...
 *
 * @MetatagTag(
 *   id = "schema_creativework_aggregate_rating",
 ...
 * )
 */
class SchemaCreativeWorkAggregateRating extends SchemaNameBase {
