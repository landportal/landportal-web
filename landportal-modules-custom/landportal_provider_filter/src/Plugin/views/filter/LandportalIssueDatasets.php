 ...
 *
 * @ViewsFilter("custom_views_issue_Datasets_field_related_themes")
 */
class LandportalIssueDatasets extends InOperator {
    ...
    public function init(ViewExecutable $view, DisplayPluginBase $display, array &$options = NULL){
        ...
        $this->valueTitle = t('Theme Datasets Count');
    ...
    public function query()
    {
        ...
        if (!empty($values_drop)) {
            ...
            foreach ($values_drop as $value) {
                ...
                $taxonomy_query->condition('vid', "datasets");
    ...
    {
        $csv_file_path = "public://csv/datasetProviderFilter/theme_datasets_counts.csv";
