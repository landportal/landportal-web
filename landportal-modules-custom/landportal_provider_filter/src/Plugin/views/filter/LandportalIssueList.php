 ...
 *
 * @ViewsFilter("custom_views_field_related_themes")
 */
class LandportalIssueList extends InOperator {
    ...
    public function init(ViewExecutable $view, DisplayPluginBase $display, array &$options = NULL){
        ...
        $this->valueTitle = t('Theme Indicator Count');
    ...
    public function query()
    {
        ...
        if (!empty($values_drop)) {
            ...
            foreach ($values_drop as $value) {
                ...
                $taxonomy_query->condition('vid', "indicators");
    ...
    {
        $csv_file_path = "public://csv/datasetProviderFilter/theme_indicator_counts.csv";
