...
//get Synonyms field value
$description->addChild('skos:AltLabel', $synonyms_synonyms, 'skos');
...
if (!$organization_types_description == null) {
  ...
  $description->addChild('skos:definition', $organization_types_description, 'skos');
  $description->addChild('skos:definition', $organization_types_description, 'skos');
}
