...
$types_of_data_description = $taxonomy->description->value;
$types_of_data_description = strip_tags($types_of_data_description);
...
//Description
if (!$types_of_data_description == null) {
  $types_of_data_description = str_replace('&nbsp;', '', $types_of_data_description);
  $description->addChild('skos:definition', $types_of_data_description, 'skos');
